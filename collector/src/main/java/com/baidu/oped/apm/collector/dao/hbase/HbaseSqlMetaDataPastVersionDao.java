...
/**
 * class HbaseSqlMetaDataPastVersionDao 
 *
 * @author meidongxu@baidu.com
 */
@Repository("hbaseSqlMetaDataPastVersionDao")
@Deprecated
public class HbaseSqlMetaDataPastVersionDao implements SqlMetaDataDao {
    ...
    public void insert(TSqlMetaData sqlMetaData) {
        ...
        put.addColumn(HBaseTables.SQL_METADATA_CF_SQL, HBaseTables.SQL_METADATA_CF_SQL_QUALI_SQLSTATEMENT, sqlBytes);
