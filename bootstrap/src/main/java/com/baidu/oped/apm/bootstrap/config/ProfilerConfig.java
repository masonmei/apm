...
public class ProfilerConfig {
    ...
    void readPropertyValues() {
        ...
        this.ningAsyncHttpClientProfileCookieDumpType =
                readDumpType("profiler.ning.asynchttpclient.cookie.dumptype", DumpType.EXCEPTION);
        this.ningAsyncHttpClientProfileCookieDumpSize = readInt("profiler.ning.asynchttpclient.cookie.dumpsize", 1024);
        this.ningAsyncHttpClientProfileCookieSamplingRate =
                readInt("profiler.ning.asynchttpclient.cookie.sampling.rate", 1);

        this.ningAsyncHttpClientProfileEntity = readBoolean("profiler.ning.asynchttpclient.entity", false);
        this.ningAsyncHttpClientProfileEntityDumpType =
                readDumpType("profiler.ning.asynchttpclient.entity.dumptype", DumpType.EXCEPTION);
        ...
        this.ningAsyncHttpClientProfileParamDumpType =
                readDumpType("profiler.ning.asynchttpclient.param.dumptype", DumpType.EXCEPTION);
        ...
        // this config must not be used in service environment because the size of  profiling information will get
        // heavy.
    ...
    public String toString() {
        ...
        sb.append(", ningAsyncHttpClientProfileCookieSamplingRate=")
        ...
        sb.append(", ningAsyncHttpClientProfileEntitySamplingRate=")
                .append(ningAsyncHttpClientProfileEntitySamplingRate);
