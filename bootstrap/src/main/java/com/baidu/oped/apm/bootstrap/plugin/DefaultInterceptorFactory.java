...
public class DefaultInterceptorFactory implements InterceptorFactory {
    ...
    public DefaultInterceptorFactory(ByteCodeInstrumentor instrumentor, TraceContext traceContext,
                                     String interceptorClassName, Object[] providedArguments, String scopeName) {
    ...
    private Interceptor createInstance(ClassLoader classLoader, TraceContext traceContext, InstrumentClass target,
