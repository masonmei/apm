...
public class TestInterceptors {
    ...
    public static class TestInterceptor2 extends AbstractInterceptor {
        ...
        public TestInterceptor2(String field0, TraceContext context, int field1, ByteCodeInstrumentor instrumentor,
                                double field2, MethodDescriptor descriptor, boolean field3, InstrumentClass targetClass,
                                MethodInfo targetMethod, long field4) {
        ...
        public TestInterceptor2(String field0, int field1, double field2, TraceContext context,
                                ByteCodeInstrumentor instrumentor, InstrumentClass targetClass,
                                MethodDescriptor descriptor, MethodInfo targetMethod) {
            this.context = context;
            this.instrumentor = instrumentor;
            this.descriptor = descriptor;
            this.targetClass = targetClass;
        ...
        public TestInterceptor2(TraceContext context, ByteCodeInstrumentor instrumentor, MethodDescriptor descriptor,
                                InstrumentClass targetClass, MethodInfo targetMethod, String field0, int field1) {
            this.context = context;
            this.instrumentor = instrumentor;
            this.descriptor = descriptor;
            this.targetClass = targetClass;
        ...
        public TestInterceptor2(TraceContext context, ByteCodeInstrumentor instrumentor, InstrumentClass targetClass,
                                MethodDescriptor descriptor, MethodInfo targetMethod) {
            this.context = context;
            this.instrumentor = instrumentor;
            this.descriptor = descriptor;
