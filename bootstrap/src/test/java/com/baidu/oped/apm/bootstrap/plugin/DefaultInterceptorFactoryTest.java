...
/**
 * class DefaultInterceptorFactoryTest
 *
...
public class DefaultInterceptorFactoryTest {
    ...
    public void test0() throws Exception {
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(instrumentor, traceContext,
                                                                                 "com.baidu.oped.apm.bootstrap.plugin"
                                                                                         + ".TestInterceptors$TestInterceptor0",
                                                                                 null, null);
    ...
    public void test3() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(instrumentor, traceContext,
                                                                                 "com.baidu.oped.apm.bootstrap.plugin"
                                                                                         + ".TestInterceptors$TestInterceptor1",
                                                                                 args, null);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    ...
    public void test9() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(instrumentor, traceContext,
                                                                                 "com.baidu.oped.apm.bootstrap.plugin"
                                                                                         + ".TestInterceptors$TestInterceptor2",
                                                                                 args, null);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
    ...
    public void test13() throws Exception {
        ...
        DefaultInterceptorFactory factory = new DefaultInterceptorFactory(instrumentor, traceContext,
                                                                                 "com.baidu.oped.apm.bootstrap.plugin.TestInterceptors$TestInterceptor2",
                                                                                 args, null);
        Interceptor interceptor = factory.getInterceptor(getClass().getClassLoader(), aClass, aMethod);
