...
public class ClassPathResolverTest {
    ...
    public void testFindAgentJar() throws Exception {
        String path =
                "D:\\nhn_source\\pinpoint_project\\deploy\\apache-tomcat-6.0.35\\bin\\bootstrap.jar;"
                        + "D:\\nhn_source\\pinpoint_project\\deploy\\agent\\agentlib/lib/javassist-3.16.1.GA.jar;"
                        + "D:\\nhn_source\\pinpoint_project\\deploy\\agent\\agentlib/lib/pinpoint-commons-0.0.2.jar;;"
        ...
        Assert.assertEquals("D:\\nhn_source\\pinpoint_project\\deploy\\agent\\agentlib" + File.separator + "lib",
                                   agentLibPath);
    }
    ...
    public void testFindAgentSnapshotJar() throws Exception {
        ...
        String agentPath = classPathResolver.getAgentJarFullPath();
        Assert.assertEquals("D:\\nhn_source\\pinpoint_project\\deploy\\agent\\agentlib/pinpoint-bootstrap-0.0"
                                    + ".2-SNAPSHOT.jar",
                                   agentPath);
