...
//        byte[] startKeyBytes = RowKeyUtils.concatFixedByteAndLong(agentIdBytes, HBaseTables.AGENT_NAME_MAX_LEN,
// fromTime);
...
//
//        List<AgentInfoBo> found = hbaseOperations2.find(HBaseTables.AGENTINFO, scan, new
// ResultsExtractor<List<AgentInfoBo>>() {
//            @Override
...
//                    byte[] serializedAgentInfo = next.getValue(HBaseTables.AGENTINFO_CF_INFO, HBaseTables
// .AGENTINFO_CF_INFO_IDENTIFIER);
//                    byte[] serializedServerMetaData = next.getValue(HBaseTables.AGENTINFO_CF_INFO, HBaseTables
// .AGENTINFO_CF_INFO_SERVER_META_DATA);
//
...
//                        agentInfoBoBuilder.serverMetaData(new ServerMetaDataBo.Builder(serializedServerMetaData)
// .build());
//                    }
...
//        AgentInfoBo agentInfoBo = hbaseOperations2.find(HBaseTables.AGENTINFO, scan, new
// ResultsExtractor<AgentInfoBo>() {
//            @Override
...
//                        agentInfoBoBuilder.startTime(startTime);
//                        if (serializedServerMetaData != null) {
//                            agentInfoBoBuilder.serverMetaData(new ServerMetaDataBo.Builder
// (serializedServerMetaData).build());
//                        }
//                        final AgentInfoBo agentInfoBo = agentInfoBoBuilder.build();
//
...
//        scan.setStartRow(startKeyBytes);
//
//        byte[] endKeyBytes = RowKeyUtils.concatFixedByteAndLong(agentIdBytes, HBaseTables.AGENT_NAME_MAX_LEN, Long
// .MAX_VALUE);
//        scan.setStopRow(endKeyBytes);
//        scan.addFamily(HBaseTables.AGENTINFO_CF_INFO);
//
